import{T as Ae,M as H,A as pe,a as p,P as E,G as N,V as T,S as L,R as G,b as oe,L as et,C as We,c as S,O as tt,B as He,F as Re,U as X,W as Y,H as q,N as Qe,d as st,e as O,f as Ue,g as ot,h as at,i as rt,j as it,k as nt,l as lt,m as ct,n as ht,o as je,p as ut,q as ft,r as dt,s as ie,t as pt,u as mt,v as gt,w as vt,x as xt,D as Fe,y as bt,z as ke,E as ae,I as k,J as wt,K as Mt,Q as Ye,X as qe,Y as Xe,Z as $e,_ as P,$ as A,a0 as ee,a1 as Ee,a2 as Be,a3 as yt}from"./three.module-CGvGw3gl.js";import{m as Ct}from"./BufferGeometryUtils-BSnYmD47.js";const Tt={vertexShader:`
    varying vec2 vUv;
    void main() {
      vUv = uv;
  ...
  `};class Ht{constructor(e,t,s,o){this.renderer=e,this.scene=t,this.camera=s,this.composer=new Rt(e),this.renderPass=new Ut(t,s),this.composer.addPass(this.renderPass),o.quality!=="low"?(this.bloom=new Q(new T(1,1),.22,.7,.9),this.composer.addPass(this.bloom)):this.bloom=null,o.quality==="high"?(this.bokeh=new kt(t,s,{focus:14,aperture:.0013,maxblur:.008}),this.composer.addPass(this.bokeh)):this.bokeh=null,this.painterly=new Ze(Wt),this.painterly.uniforms.tAngle.value=Vt(),this.painterly.uniforms.uLength.value=o.quality==="high"?13:9,this.painterly.uniforms.uStrength.value=o.quality==="high"?.6:.52,this.composer.addPass(this.painterly),this.composer.addPass(new Et)}composer;painterly;bloom;bokeh;renderPass;width=1;height=1;setPainterly(e){this.painterly.uniforms.uStrength.value=e}setSize(e,t,s){this.width=e,this.height=t,this.composer.setPixelRatio(s),this.composer.setSize(e,t),this.painterly.uniforms.uTexel.value.set(1/(e*s),1/(t*s)),this.bloom?.setSize(e,t)}render(){this.composer.render()}get size(){return{width:this.width,height:this.height}}dispose(){this.composer.dispose(),this.bloom?.dispose(),this.bokeh?.dispose(),this.painterly.dispose(),this.renderPass.dispose()}}const C={sky:12575970,fog:3364442,bark:16771280,barkFar:10470604,foliage:15660258,foliageFar:14478570,grass:6581056,lionBody:15907683,lionBodyDark:14129727,lionMane:13664040,lionManeLight:16174207,muzzle:14264159,face:2890258,cloth:16777215,clothDark:9377296},Ke=42,fe=1.45,de=1;function Qt(i,e){const t=Math.hypot(e+7.4,fe-de),s=Math.tan(Ke/2*(Math.PI/180))*t;return{width:s*i,height:s}}function F(i){const e=i.map(s=>{const o=s.geometry.clone();return o.applyMatrix4(new Ye().compose(new S(...s.position??[0,0,0]),new qe().setFromEuler(new Xe(...s.rotation??[0,0,0])),new S(...s.scale??[1,1,1]))),o.index?o.toNonIndexed():o}),t=Ct(e,!1)??new He;for(const s of e)s.dispose();for(const s of i)s.geometry.dispose();return t}function j(i){return new k({color:i.color,map:i.map,roughness:i.roughness??.92,metalness:0})}function he(i,e,t){const s=[];for(let r=0;r<=14;r+=1){const l=r/14,n=1+Math.pow(1-l,3)*1.35,f=1-l*.42,c=1+Math.sin(l*Math.PI*3)*.035;s.push(new T(e*f*n*c,l*i))}const a=new $e(s,32);return a.computeVertexNormals(),new p(a,t)}function jt(i,e,t){const s=[];let o=t;const a=()=>(o=o*16807%2147483647,o/2147483647);for(let r=0;r<6;r+=1){const l=a()*Math.PI*2,n=a()*i*.55,f=i*(.42+a()*.3);s.push({geometry:new A(f,12,9),position:[Math.cos(l)*n,(a()-.35)*i*.45,Math.sin(l)*n],scale:[1.05,.85+a()*.25,1.05]})}return new p(F(s),e)}function Yt(){const e=new N,t=new k({color:C.lionBody,roughness:.9,metalness:0}),s=new k({color:C.lionBodyDark,roughness:.92,metalness:0}),o=new k({color:C.lionMane,roughness:.98,metalness:0,bumpMap:Ge(),bumpScale:.06}),a=new k({color:C.lionManeLight,roughness:.98,metalness:0,bumpMap:Ge(),bumpScale:.05});new k({color:C.muzzle,roughness:.85,metalness:0});const r=new k({color:C.face,roughness:.45,metalness:0});e.add(new p(F([{geometry:new P(.42,0),position:[-.36,.42,-.34],scale:[1,.95,1.15]},{geometry:new P(.42,0),position:[.36,.42,-.34],scale:[1,.95,1.15]},{geometry:new A(.44,26,20),position:[0,1.04,-.12],scale:[1.05,1.35,.95]},{geometry:new A(.44,26,20),position:[0,.9,-.58],scale:[1,.92,1.05]},{geometry:new A(.28,14,11),position:[0,1.46,.04],scale:[1.05,.9,1]}]),t));const l=[],n=[];for(const d of[-.24,.24]){l.push({geometry:new ee(.095,.115,.98,12),position:[d,.52,.22]}),n.push({geometry:new A(.14,12,10),position:[d,.09,.3],scale:[1.05,.62,1.5]});for(const w of[-.06,0,.06])n.push({geometry:new A(.045,8,6),position:[d+w,.05,.46]})}for(const d of[-.44,.44])l.push({geometry:new ee(.115,.135,.52,12),position:[d,.3,-.18],rotation:[1,0,0]}),n.push({geometry:new A(.15,12,10),position:[d,.09,.06],scale:[1.1,.62,1.6]});e.add(new p(F(l),t)),e.add(new p(F(n),s));const f=new p(new A(.44,26,20),t);f.position.set(0,1,.16),f.scale.set(1,1.15,.95),e.add(f);const c=new N;c.position.set(0,1.78,.14),c.add(new p(F([{geometry:new A(.29,26,20),scale:[1,.96,1.06]},{geometry:new ee(.09,.19,.36,16),position:[0,-.13,.3],rotation:[Math.PI/2,0,0],scale:[.86,1,1]},{geometry:new A(.09,10,8),position:[0,-.25,.3],scale:[1.2,.9,1]},{geometry:new Ee(.34,.05,.14),position:[0,.12,.24]}]),t)),c.add(new p(new Be(.075,.1,3),r).translateY(0).translateZ(0));const u=c.children[c.children.length-1];u.position.set(0,-.08,.47),u.rotation.set(Math.PI/2,0,Math.PI),c.add(new p(new Ee(.13,.012,.08),r).translateY(0).translateZ(0)),c.children[c.children.length-1].position.set(0,-.22,.4),c.add(new p(F([{geometry:new A(.062,10,8),position:[-.15,.05,.27],scale:[1.9,.3,.5],rotation:[0,0,.34]},{geometry:new A(.062,10,8),position:[.15,.05,.27],scale:[1.9,.3,.5],rotation:[0,0,-.34]}]),r));const g=[{geometry:new P(.66,1),position:[0,-.06,-.18],scale:[1.18,1.22,.6]},{geometry:new P(.3,0),position:[-.42,.06,.06],scale:[.95,1.15,.6],rotation:[0,0,.5]},{geometry:new P(.3,0),position:[.42,.06,.06],scale:[.95,1.15,.6],rotation:[0,0,-.5]},{geometry:new P(.26,0),position:[-.3,-.36,.16],scale:[.95,1.2,.6],rotation:[0,0,.25]},{geometry:new P(.26,0),position:[.3,-.36,.16],scale:[.95,1.2,.6],rotation:[0,0,-.25]},{geometry:new P(.3,0),position:[-.3,-.62,.02],scale:[1,1.3,.68]},{geometry:new P(.3,0),position:[.3,-.62,.02],scale:[1,1.3,.68]},{geometry:new P(.32,0),position:[0,-.8,.06],scale:[1.05,1.2,.68]},{geometry:new P(.42,0),position:[-.56,-.24,-.1],scale:[.95,1.15,.62]},{geometry:new P(.42,0),position:[.56,-.24,-.1],scale:[.95,1.15,.62]}],v=[{geometry:new P(.34,0),position:[0,.34,-.04],scale:[1.2,.8,.7]},{geometry:new P(.28,0),position:[-.5,.16,-.02],scale:[.95,1,.62],rotation:[0,0,.35]},{geometry:new P(.28,0),position:[.5,.16,-.02],scale:[.95,1,.62],rotation:[0,0,-.35]}];c.add(new p(F(g),o)),c.add(new p(F(v),a));const b=[];for(const d of[-.23,.23]){const w=new p(new Be(.095,.17,5),a);w.position.set(d,.3,.06),w.rotation.z=d<0?.4:-.4,c.add(w),b.push(w)}e.add(c);const x=[];let R=e;for(let d=0;d<2;d+=1){const w=new N;w.position.set(0,d===0?.5:.02,d===0?-.94:-.3);const D=new p(new ee(.07-d*.012,.08-d*.012,.32,10),t);if(D.rotation.x=Math.PI/2+.5,D.position.z=-.16,w.add(D),d===1){const _=new p(new P(.11,0),o);_.scale.set(.9,1.5,.9),_.position.set(0,-.18,-.3),w.add(_)}R.add(w),R=w,x.push(w)}return e.scale.setScalar(1.16),{group:e,head:c,headBaseY:1.34,tail:x,ears:b,chest:f}}function qt(){const i=new N,e=j({color:C.cloth,map:zt(),roughness:.95}),t=new k({color:C.clothDark,roughness:.9,metalness:0}),s=[],o=16;for(let c=0;c<=o;c+=1){const u=c/o,h=.16+Math.pow(u,1.5)*.3+Math.sin(u*Math.PI)*.05;s.push(new T(h,1.02-u*1))}const a=new $e(s,32);a.computeVertexNormals();const r=new p(a,e);i.add(r);const l=new p(new A(.18,16,12),e);l.scale.set(1,1.12,1.08),l.position.set(0,1.06,.01),i.add(l);const n=new p(new A(.2,14,11),e);n.scale.set(1.5,.6,.9),n.position.set(0,.92,0),i.add(n);const f=new p(new A(.1,12,10),t);return f.scale.set(1,1.15,.6),f.position.set(0,1.05,.13),i.add(f),i.scale.setScalar(.68),{group:i,cloak:r,basePositions:Float32Array.from(a.attributes.position.array)}}function Xt(i){const e=new E(.17,.24),t=new k({map:Nt(),transparent:!0,alphaTest:.4,side:ae,roughness:1,metalness:0}),s=new yt(e,t,i);s.frustumCulled=!1;const o=new Float32Array(i*6);for(let a=0;a<i;a+=1)o[a*6+0]=-6+Math.random()*12,o[a*6+1]=.4+Math.random()*4.8,o[a*6+2]=-5+Math.random()*10,o[a*6+3]=.5+Math.random()*1.2,o[a*6+4]=Math.random()*Math.PI*2,o[a*6+5]=(Math.random()-.5)*3;return{mesh:s,state:o}}function Ve(){try{const s=new URLSearchParams(window.location.search).get("fx");if(s==="low"||s==="medium"||s==="high")return s}catch{}const i=typeof window.matchMedia=="function"&&window.matchMedia("(pointer: coarse)").matches,e=navigator.hardwareConcurrency??4;return!i&&e>=4?"high":e>=4?"medium":"low"}class Kt{constructor(e){this.canvas=e,this.renderer=new pt({canvas:e,antialias:!0,powerPreference:"low-power"}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=mt,this.renderer.toneMapping=je,this.renderer.toneMappingExposure=1,this.scene.background=new O(C.sky),this.scene.fog=new gt(C.fog,16,30),this.camera=new vt(Ke,2/3,.1,90),this.camera.position.set(0,fe,7.4),this.camera.lookAt(0,de,0);const t=Lt();this.scene.add(new xt(14479344,3498094,1.05));const s=new Fe(16761976,1.15);s.position.set(4,7.5,-6),s.castShadow=!0,s.shadow.mapSize.set(512,512),s.shadow.camera.left=-7,s.shadow.camera.right=7,s.shadow.camera.top=8,s.shadow.camera.bottom=-2,s.shadow.bias=-.0012,s.shadow.radius=3,this.scene.add(s);const o=new Fe(8832742,1.5);o.position.set(-5,3,5),this.scene.add(o);const a=new bt(16767392,13,12,Math.PI/9,.8,1.6);a.position.set(-1.4,4.2,4.6),a.target.position.set(-.3,1,1.6),this.scene.add(a),this.scene.add(a.target);const r=new E(70,40,1,8),l=r.attributes.position,n=new Float32Array(l.count*3),f=new O(C.sky),c=new O(C.fog);for(let m=0;m<l.count;m+=1){const U=(l.getY(m)+20)/40,M=c.clone().lerp(f,U);n[m*3]=M.r,n[m*3+1]=M.g,n[m*3+2]=M.b}r.setAttribute("color",new ke(n,3));const u=new H({vertexColors:!0,fog:!1,side:ae}),h=new p(r,u);h.position.set(0,8,-22),this.addForest(h),this.disposables.push(r,u);const g=new E(46,46,18,18),v=g.attributes.position,b=new Float32Array(v.count*3),x=new O;for(let m=0;m<v.count;m+=1){const U=v.getX(m),M=v.getY(m);v.setZ(m,Math.sin(U*.28)*.09+Math.cos(M*.24)*.07);const I=(Math.sin(U*.5)+Math.cos(M*.42))*.5,W=I>.35?1.16:I<-.35?.82:1,J=Math.min(1,Math.max(0,M/23));x.setHex(C.grass).multiplyScalar(W*(1-J*.3)),b[m*3]=x.r,b[m*3+1]=x.g,b[m*3+2]=x.b}g.setAttribute("color",new ke(b,3)),g.computeVertexNormals();const R=new k({map:Bt(),vertexColors:!0,roughness:1,metalness:0,bumpMap:t,bumpScale:.02}),d=new p(g,R);d.rotation.x=-Math.PI/2,d.receiveShadow=!0,this.ground=d,this.scene.add(d),this.disposables.push(g,R);const w=j({color:C.bark,map:Le()}),D=j({color:C.barkFar,map:Le(),roughness:1}),_=j({color:C.foliage,map:Ie(),roughness:1}),ce=j({color:C.foliageFar,map:Ie(),roughness:1});this.disposables.push(w,D,_,ce);const $=new N;$.name="leftFrame";const ge=he(13,.6,w);ge.castShadow=!0,$.add(ge),$.add(this.placeCanopy(11.6,1.05,_,7)),this.addForest($);const Z=new N;Z.name="rightFrame";const ve=he(13.6,.66,D);ve.castShadow=!0,Z.add(ve),Z.add(this.placeCanopy(12.2,1.1,_,11)),this.addForest(Z);const Je=[[-1.6,-10,12],[.9,-11,13],[-3,-15,15],[2.8,-16,15]],xe=[],be=[];Je.forEach(([m,U,M],I)=>{const W=he(M,M*.05,D).geometry.clone();W.translate(m,0,U),xe.push({geometry:W});const J=this.placeCanopy(M*.92,M*.16,ce,I*13+5),De=J.geometry.clone();De.translate(m,M*.92,U),be.push({geometry:De}),J.geometry.dispose()});const we=new p(F(xe),D);we.name="farTrunks";const Me=new p(F(be),ce);Me.name="farCanopies",this.addForest(we),this.addForest(Me);const K=new N;K.name="canopyTop",K.add(this.placeCanopy(0,.55,_,3)),this.addForest(K),this.foliage.push(K);for(const[m,U]of[["canopyleft",-1],["canopyright",1]]){const M=new N;M.name=m,M.add(this.placeCanopy(0,.7,_,U<0?17:23)),this.addForest(M),this.foliage.push(M)}const ye=new H({map:It(),transparent:!0,blending:pe,depthWrite:!1,side:ae,opacity:.85}),Ce=[];for(const[m,U,M,I,W]of[[-2.2,-3.2,1.5,9,.14],[-.6,-4.4,1.9,10,.1],[1.4,-3.6,1.4,8.5,-.12]])Ce.push({geometry:new E(M,I),position:[m,I/2-.4,U],rotation:[0,0,W]});const Te=new p(F(Ce),ye);Te.renderOrder=2,this.addForest(Te),this.disposables.push(ye);const Se=new H({map:Gt(),transparent:!0,depthWrite:!1,side:ae,opacity:.55}),_e=[];for(const[m,U,M]of[[-6,.7,1.6],[-12,1.1,2.2]])_e.push({geometry:new E(26*M,3.4*M),position:[0,U,m]});const Pe=new p(F(_e),Se);Pe.renderOrder=1,this.addForest(Pe),this.disposables.push(Se),this.lion=Yt(),this.lion.group.position.set(-.3,0,1.6),this.lion.group.rotation.y=-.12,this.lion.group.scale.setScalar(.85),this.lion.group.traverse(m=>{m instanceof p&&(m.castShadow=!0)}),this.scene.add(this.lion.group),this.traveler=qt(),this.traveler.group.position.set(.35,0,2.6),this.traveler.group.rotation.y=Math.PI-.25,this.traveler.group.scale.setScalar(.6),this.traveler.group.traverse(m=>{m instanceof p&&(m.castShadow=!0)}),this.scene.add(this.traveler.group),this.leaves=Xt(45),this.scene.add(this.leaves.mesh),this.disposables.push(this.leaves.mesh.geometry,this.leaves.mesh.material),this.postfx=new Ht(this.renderer,this.scene,this.camera,{quality:Ve()}),this.resize(e.clientWidth,e.clientHeight),this.layout(),this.loadPlates(),this.animate()}renderer;postfx;scene=new wt;camera;clock=new Mt;lion;forest=[];loaded={plates:!1};plates=null;spray=null;ground=null;traveler;leaves;foliage=[];matrix=new Ye;disposables=[];frame=0;fpsAccum=0;fpsFrames=0;fps=0;wind=0;get assets(){return{...this.loaded}}get quality(){return this.postfx?this.postfx.constructor.name:"нет"}placeCanopy(e,t,s,o){const a=jt(t,s,o);return a.position.y=e,a}alignToNdc(e,t,s,o){e.position.z=o;const a=new S;for(let r=0;r<8;r+=1){e.getWorldPosition(a),a.project(this.camera);const{width:l,height:n}=Qt(this.camera.aspect,o);e.position.x+=(t-a.x)*l*.85,e.position.y+=(s-a.y)*n*.85}}layout(){const t=this.scene.getObjectByName("leftFrame"),s=this.scene.getObjectByName("rightFrame");t&&this.alignToNdc(t,-.86,-.5,-1.2),s&&this.alignToNdc(s,.86,-.5,-1.2);const o=this.scene.getObjectByName("canopyTop");o&&this.alignToNdc(o,0,1.06,-1.2-.6);for(const[a,r]of[["canopyleft",-1],["canopyright",1]]){const l=this.scene.getObjectByName(a);l&&this.alignToNdc(l,r*.9,.92,-1.2)}}addForest(e){this.scene.add(e),this.forest.push(e)}loadPlates(){const e=new me(this.camera,{base:"./title/layers/",quality:Ve(),animate:!1,onReady:()=>{this.loaded.plates=!0,this.hideProcedural(),this.postfx?.setPainterly(.18)}});this.plates=e,this.scene.add(e.object3d)}hideProcedural(){for(const e of this.forest)e.visible=!1;this.ground&&(this.ground.visible=!1),this.lion.group.visible=!1,this.traveler.group.visible=!1}resize(e,t){const s=e/Math.max(1,t);this.camera.aspect=s;const o=7.4+Math.max(0,s-1)*3;this.camera.position.set(0,fe+Math.max(0,s-1)*.4,o),this.camera.lookAt(0,de,0),this.camera.updateProjectionMatrix(),this.renderer.setSize(e,t,!1),this.postfx.setSize(e,t,Math.min(window.devicePixelRatio||1,2)),this.layout(),this.plates?.layout()}setPointer(e,t){this.plates?.setPointer(e,t)}animate=()=>{this.frame=requestAnimationFrame(this.animate);const e=Math.min(this.clock.getDelta(),.05);if(document.hidden)return;const t=this.clock.elapsedTime;this.wind=Math.sin(t*.55)*.6+Math.sin(t*1.7)*.25+.4,this.plates?.update(t),this.spray?.update(e,this.wind);const s=1+Math.sin(t*2.1)*.025;this.lion.chest.scale.setScalar(s),this.lion.head.rotation.y=Math.sin(t*.45)*.12,this.lion.head.rotation.x=Math.sin(t*.7+1)*.05,this.lion.head.position.y=this.lion.headBaseY+Math.sin(t*2.1)*.014,this.lion.ears.forEach((c,u)=>{const h=Math.max(0,Math.sin(t*.9+u*2.1)-.93)*12;c.rotation.z=(u===0?.34:-.34)+h*(u===0?1:-1)}),this.lion.tail.forEach((c,u)=>{c.rotation.y=Math.sin(t*1.1-u*.5)*(.12+u*.05)*(.8+this.wind*.6),c.rotation.x=-.1+Math.sin(t*.8-u*.4)*.08});const o=this.traveler.cloak,a=o.geometry.attributes.position,r=this.traveler.basePositions;for(let c=0;c<a.count;c+=1){const u=r[c*3]??0,h=r[c*3+1]??0,g=r[c*3+2]??0,v=Math.max(0,.55-h)/.55,b=Math.atan2(g,u),x=this.wind*(.14+.06*Math.sin(t*2.6+b*3));a.setXYZ(c,u+Math.sin(b)*v*x+Math.sin(t*3+b*2)*v*.014,h-Math.abs(x)*v*.07,g+Math.cos(b)*v*x+Math.cos(t*2.4+b*2)*v*.014)}a.needsUpdate=!0,o.geometry.computeVertexNormals(),this.foliage.forEach((c,u)=>{c.rotation.z=Math.sin(t*.9+u)*.028*(.6+this.wind)});const{mesh:l,state:n}=this.leaves,f=n.length/6;for(let c=0;c<f;c+=1){const u=c*6;let h=n[u]??0,g=n[u+1]??0,v=n[u+2]??0;const b=n[u+3]??1,x=n[u+4]??0,R=n[u+5]??1;h+=(b*(.6+this.wind)+.35)*e*1.7,g+=Math.sin(t*1.6+x)*e*.5,v+=Math.cos(t*1.1+x)*e*.3,h>8&&(h=-8,g=.4+Math.random()*4.8,v=-5+Math.random()*10),n[u]=h,n[u+1]=g,n[u+2]=v;const d=.85+Math.sin(t*2+x)*.15;this.matrix.compose(new S(h,g,v),new qe().setFromEuler(new Xe(t*R,x+t*.8,Math.sin(t*1.5+x)*.7)),new S(d,d,d)),l.setMatrixAt(c,this.matrix)}l.instanceMatrix.needsUpdate=!0,this.postfx.render(),this.fpsAccum+=e,this.fpsFrames+=1,this.fpsAccum>=.5&&(this.fps=Math.round(this.fpsFrames/this.fpsAccum),this.fpsAccum=0,this.fpsFrames=0)};get stats(){let e=0,t=0;return this.scene.traverse(s=>{if(!(s instanceof p))return;e+=1;const o=s.geometry,a=o.getAttribute("position"),r=o.getIndex();r?t+=r.count/3:a&&(t+=a.count/3)}),{calls:e,triangles:Math.round(t),fps:this.fps}}get objectCount(){let e=0;return this.scene.traverse(()=>{e+=1}),e}screenPositionOf(e){const t=this.scene.getObjectByName(e);if(!t)return null;const s=new S;return t.getWorldPosition(s),s.project(this.camera),{x:s.x,y:s.y}}dispose(){this.spray?.dispose(),this.spray=null,cancelAnimationFrame(this.frame),this.postfx.dispose();for(const e of this.disposables)e.dispose();this.scene.traverse(e=>{if(e instanceof p){e.geometry.dispose();for(const t of Array.isArray(e.material)?e.material:[e.material])t.dispose()}}),this.scene.clear(),Ot(),this.renderer.dispose()}}export{C as TITLE_PALETTE,Kt as TitleScene};
//# sourceMappingURL=titleScene-B0quKE2f.js.map
